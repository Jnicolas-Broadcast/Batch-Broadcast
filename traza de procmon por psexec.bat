@ECHO OFF
cd c:\
PsExec64.exe -sd \\SISTEMA_14_712 c:\procmon64.exe -accepteula -backingfile c:\temp\proc.pml -quiet
REM luego de "\\SISTEMA_14_712" sigue la ruta del ejecutable "procmon64.exe" ubicado en ese SISTEMA_14_712, y en su disco raiz.
...
PAUSE
REM --------------------------------------------------------------------------------------------------------------
Psexec64.exe -sd \\SISTEMA_14_712 c:\procmon64.exe -accepteula -terminate -quiet
msg * "concluye la traza del processmonitor"
xcopy \\SISTEMA_14_712\c$\temp\proc.pml c:\
